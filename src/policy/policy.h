...
/** Recommended transaction fee by Moirai Core developers
  *
 ...
 *
 *  Moirai:    Increment mempool limits and accept RBF in steps of 0.0001 MOI
...
/**
 * Moirai: Default dust limit that is evaluated when considering whether a
...
/**
 * Moirai: Default hard dust limit that is evaluated when considering whether
