...
const char * const BITCOIN_CONF_FILENAME = "moirai.conf";
const char * const BITCOIN_PID_FILENAME = "moiraid.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Moirai";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Moirai";
#else
    // Unix
    return pathRet / ".moirai";
#endif
#endif
}
