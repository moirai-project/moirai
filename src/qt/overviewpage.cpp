...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Moirai Core repository on GitHub"),
        tr("Services that claim to double your moirais are always ponzi schemes")
    };
