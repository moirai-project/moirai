...
// Copyright (c) 2020-2023 The Moirai Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Moirai: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Moirai (as there is no actual maximum coins)
