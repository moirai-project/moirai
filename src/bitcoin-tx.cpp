...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s moirai-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  moirai-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded moirai transaction") + "\n" +
              "  moirai-tx [options] -create [commands]   " + _("Create hex-encoded moirai transaction") + "\n" +
              "\n";
