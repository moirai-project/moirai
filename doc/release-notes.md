Moirai Core version 1.0.0 is now available from:

  <https://github.com/moirai-project/moirai/releases/tag/v1.0.0/>

This is a new minor version release. Moirai users on any platform are
...
Several important updates have been added to Moirai Core, including fixes
backported from Bitcoin Core's upstream.

### Reduce Peer INV Object Counts

Previously, Moirai Core nodes would maintain a large list of inventory for
...
A new transaction request tracking system improves the way Moirai Core
...
In previous versions of Moirai Core, orphan transactions were processed in a
...
Moirai Core now sends a getheaders message for one block when announced in an
...
vulnerability or security issue in Moirai Core.
...
* Moirai Core now supports compilation with C++14 and C++17, if you select
