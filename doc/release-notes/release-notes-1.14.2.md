Moirai Core version 1.14.2 is now available from:

  <https://github.com/moirai-project/moirai/releases/tag/v1.14.2/>
...
Moirai Core introduces pruning the blockchain in 1.14. Pruning
...
When Moirai Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in Moirai-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Moirai Core. This was added in conjunction with
